          ...
          <div key={therapist.id} className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border overflow-hidden hover:shadow-md transition-shadow group">
            <div className="h-24 bg-teal-500 relative">
              <div className="absolute -bottom-10 left-6">
                <div className="w-20 h-20 rounded-full bg-white dark:bg-slate-900 p-1 shadow-md">
                  <div className="w-full h-full rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center overflow-hidden">
                    {therapist.photo_url ? (
              ...
              <button 
                ...
                className="absolute top-4 right-4 bg-white dark:bg-slate-900/20 hover:bg-white dark:bg-slate-900/30 text-white p-2 rounded-full backdrop-blur-sm transition-colors opacity-0 group-hover:opacity-100"
              >
                <Edit2 size={16} />
              </button>
            </div>
            ...
            <div className="pt-12 px-6 pb-6 space-y-4">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-slate-50">{therapist.name}</h3>
              ...
              <div className="flex gap-2 pt-2">
                <div className="flex-1 bg-gray-50 dark:bg-slate-800/50 rounded-lg p-2 text-center">
                  <div className="flex items-center justify-center gap-1 text-xs text-gray-500 dark:text-slate-500 mb-1">
